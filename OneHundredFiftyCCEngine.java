/* Emolyn Tumwebaze
   3/14/2021
   This class creates a OneHundredFiftyCCEngine as an option for the user to pick and play the game.
* */

public class OneHundredFiftyCCEngine extends Engine {

    private double SPEED_THRESHOLD;     // Represents how fast a car can move
    private double POWER_THRESHOLD;     // Represents the maximum output torque of a given 150 cc engine.

    // Default Constructor
    public OneHundredFiftyCCEngine() {
        this("(150 CC)", 8, true);
    }

    // initializes the following attributes for the construction of a 150 cc engine.
    public OneHundredFiftyCCEngine(String name, int numOfCylinders, boolean isSingleOrDualCamShaft) {
    ...
    public boolean equals(Object o) {
        ...
        OneHundredFiftyCCEngine obj = (OneHundredFiftyCCEngine) o;
